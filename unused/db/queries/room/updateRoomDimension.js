...
var updateRoomDimensionData = function (userId, projectPublicId, roomId, roomDimensionData) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, room, filteredData;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                filteredData = Object.keys(roomDimensionData)
                    .filter(function (key) { return roomDimensionData[key]; })
                    .reduce(function (prev, cur) {
                    var _a;
                    return (__assign(__assign({}, prev), (_a = {}, _a[cur] = roomDimensionData[cur], _a)));
                }, {});
                return [2 /*return*/, __1.prisma.room.update({
                        where: {
                            id: room.id
                        },
                        data: filteredData
...
exports["default"] = updateRoomDimensionData;
