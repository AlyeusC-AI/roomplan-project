...
var updateCost = function (userId, projectPublicId, type, costId, costData) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, cost;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, __1.prisma.cost.findFirst({
                        where: {
                            id: costId,
            ...
            case 3:
                ...
                return [2 /*return*/, __1.prisma.cost.update({
                        where: {
                            id: costId
                        },
                        data: __assign({}, costData)
                    })];
        }
    });
}); };
exports["default"] = updateCost;
