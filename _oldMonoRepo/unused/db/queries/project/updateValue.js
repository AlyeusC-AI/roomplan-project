...
var updateValue = function (userId, projectPublicId, valueData) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, __1.prisma.project.update({
                        ...
                        data: __assign({}, valueData)
                    })];
        }
    });
}); };
exports["default"] = updateValue;
