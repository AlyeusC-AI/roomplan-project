...
var createRoomReading = function (userId, projectPublicId, roomId, readingData) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, room;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, __1.prisma.roomReading.create({
                        data: __assign(__assign({}, (readingData ? readingData : {})), { roomId: room.id, publicId: (0, uuid_1.v4)(), projectId: project.id }),
                        select: {
                            publicId: true,
                            humidity: true,
                            temperature: true,
...
exports["default"] = createRoomReading;
