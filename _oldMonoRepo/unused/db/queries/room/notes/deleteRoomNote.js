...
var deleteRoomNote = function (userId, projectPublicId, roomId, noteId) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, room, note;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                return [2 /*return*/, __1.prisma.notes.update({
                        where: {
                            id: note.id
                        },
                        data: {
                            ...
                            notesAuditTrail: {
                                create: {
                                    action: __2.NotesAuditAction.deleted,
                                    body: note.body,
                                    userId: userId,
...
exports["default"] = deleteRoomNote;
