...
//           className='flex size-16 items-center justify-center focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black md:hidden md:w-40 md:bg-primary'
//         >
...
//             >
//               <Dialog.Panel
//                 className='fixed inset-0 z-40 size-full overflow-scroll bg-white md:inset-y-0 md:left-auto md:right-0 md:w-full md:max-w-sm md:shadow-lg'
//                 aria-label='Global'
//               >
...
//                     <XCircleIcon className='block size-6' aria-hidden='true' />
//                   </button>
//                 </div>
...
//                         key={item.name}
//                         href={item.href}
//                         className='flex rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50'
//                       >
//                         {item.icon && (
//                           <item.icon
//                             className={clsx(
...
//                   </div>
//                 </div>
//                 <div className='max-w-8xl mx-auto px-2 py-3 md:px-4'>
//                   {navigation.map((item) => (
//                     <Fragment key={item.name}>
//                       <Link
//                         href={item.href}
//                         className={clsx(
//                           "flex rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-blue-500 hover:text-white",
//                           pathname!.indexOf(item.href) >= 0 && "text-blue-500"
//                         )}
//                       >
//                         {item.icon && (
//                           <item.icon
//                             className={clsx("-ml-1 mr-3 size-6 shrink-0")}
//                             aria-hidden='true'
//                           />
//                         )}
//                         {item.name}
...
//                           href={child.href}
//                           className={clsx(
//                             "ml-3 flex rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-blue-500 hover:text-white",
