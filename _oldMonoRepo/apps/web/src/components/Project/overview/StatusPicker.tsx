...
//   const setSelected = async (option: Status) => {
//     if (!option) return;
//     if (!option.publicId) {
...
//                 leaveTo='opacity-0'
//               >
//                 <Listbox.Options className='ring-primary-action absolute right-0 z-10 mt-2 w-80 origin-top-right divide-y divide-gray-200 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-opacity-5 focus:outline-none'>
//                   <Listbox.Option
//                     className={({ active }) =>
//                       clsx(
//                         "text-gray-900",
...
//                             className='focus:border-primary-action focus:ring-primary-action block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 shadow-sm placeholder:text-gray-400 focus:outline-none sm:text-sm'
//                           />
//                         </div>
//                         <label
//                           htmlFor='description'
...
//                           id='color'
//                           name='color'
//                           className='focus:border-primary-action focus:ring-primary-action mt-1 block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base focus:outline-none sm:text-sm'
//                           defaultValue='Red'
