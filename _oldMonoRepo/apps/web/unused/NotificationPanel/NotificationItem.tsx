...
import { BellDotIcon, BellIcon, EllipsisVerticalIcon } from "lucide-react";
...
export default function NotificationItem({
  ...
  return (
    <li>
      <div
        className={clsx(
          "group relative flex items-center px-5 py-6",
      ...
      >
        ...
        >
          <Menu.Button className='group relative inline-flex size-8 items-center justify-center rounded-full bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2'>
