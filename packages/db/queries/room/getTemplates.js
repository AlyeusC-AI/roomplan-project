...
var getTemplates = function (userId, projectPublicId, roomId, fetchAll) {
    if (fetchAll === void 0) { fetchAll = false; }
    return __awaiter(void 0, void 0, void 0, function () {
        var servicegeekUser, organizationId, project, templatesToUse, usedTemplates, room;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    templatesToUse = templates_1["default"];
                    usedTemplates = [];
                ...
                case 3:
                    ...
                    if (!fetchAll) {
                        templatesToUse = templates_1["default"].filter(function (template) {
                            return template.isApplicable(room.name);
                        });
                    }
                    return [4 /*yield*/, __1.prisma.templatesUsed.findMany({
                            where: {
                                roomId: room.id
                            },
                            select: {
                ...
                case 4:
                    usedTemplates = _b.sent();
                    return [2 /*return*/, templatesToUse
                            .sort(function (a, b) { return (a.name > b.name ? 1 : -1); })
                            .map(function (t) { return (__assign(__assign({}, t), { hasBeenApplied: !!usedTemplates.find(function (template) { return template.templateCode === t.id; }) })); })];
            }
        });
    });
};
