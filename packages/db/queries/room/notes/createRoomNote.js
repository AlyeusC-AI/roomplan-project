...
var createRoomNote = function (userId, projectPublicId, roomId, body) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, __1.prisma.notes.create({
                        data: {
                            body: body || "",
                            roomId: room.id,
                            ...
                            notesAuditTrail: {
                                create: {
                                    action: __1.NotesAuditAction.deleted,
                                    body: "",
                                    userId: userId,
...
exports["default"] = createRoomNote;
