...
var createRoom = function (userId, projectPublicId, name) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, room, publicId;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                room = _b.sent();
                if (room)
                    return [2 /*return*/, { failed: true, reason: "existing-room" }];
