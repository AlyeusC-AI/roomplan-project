...
var deleteRoomReading = function (userId, projectPublicId, roomId, readingId) { return __awaiter(void 0, void 0, void 0, function () {
    var servicegeekUser, organizationId, project, room, reading;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 4:
                ...
                return [2 /*return*/, __1.prisma.roomReading.update({
                        where: {
                            id: reading.id
                        },
                        data: {
...
exports["default"] = deleteRoomReading;
