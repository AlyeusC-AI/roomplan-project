...
var createWeatherReportItem = function (userId, projectPublicId, date, time, f_scale, speed, size, location, county, state, lat, lon, comments) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, __1.prisma.weatherReportItem.create({
                        data: {
...
exports["default"] = createWeatherReportItem;
