...
var getIsAdmin_1 = require("../organization/getIsAdmin");
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                orgId = (_a = user.org) === null || _a === void 0 ? void 0 : _a.id;
                if (!orgId) return [3 /*break*/, 3];
                return [4 /*yield*/, (0, getIsAdmin_1["default"])(orgId, user.id)];
            case 2:
                isAdmin = _b.sent();
                if (isAdmin) {
