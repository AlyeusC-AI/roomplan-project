...
var addNoteToImage = function (userId, projectPublicId, imageId, body, mentions) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, __1.prisma.imageNote.create({
                        data: {
                            body: body || "",
                            userId: userId,
                            mentions: mentions || [],
...
exports["default"] = addNoteToImage;
