...
export default async function PrivacyPage() {
  ...
  return (
    ...
    <div className="flex w-full items-center justify-center bg-background">
      <div className="prose px-6 mt-10">
        ...
        <p>
          ...
          Personal Data that We have collected about You. Submit a request at
          our <a href="/data-deletion-request">Data Deletion Page</a> to
        ...
        <ul>
          ...
          <li>
            ...
            vendors to deliver targeted advertising to You, third-party vendors
