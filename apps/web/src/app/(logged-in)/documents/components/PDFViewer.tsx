...
export default function PDFViewer({
  ...
  const handleConfirmPlaceholder = () => {
    ...
    setPlaceholderName("");
    setSelectedInputType("signature");
    toast.success("Client input placeholder added");
  };

  return (
    <div className='resp-zoom col-span-9'>
      <div className='rounded-xl border border-gray-200 bg-white p-6 shadow-sm'>
        {currentDocument ? (
          <div className='space-y-6'>
            ...
            >
              {isViewing && (
                <div className='absolute right-4 top-4 z-50 flex items-center gap-2 rounded-lg bg-white/80 p-2 shadow-lg backdrop-blur-sm'>
                  <Button
                    variant='outline'
                    size='sm'
                    onClick={() => {
                      ...
                      for (const [pageNum, pageAnnotations] of allPages) {
                        ...
                        if (placeholder) {
                          ...
                          setShowSignaturePad &&
                            setShowSignaturePad(placeholder);
                          break;
                        }
                      }
                    }}
              ...
              <div className='absolute bottom-4 left-1/2 z-50 flex -translate-x-1/2 transform items-center gap-2 rounded-lg bg-white/80 p-2 shadow-lg backdrop-blur-sm'>
                <Button
                  variant='ghost'
                  size='sm'
                ...
                {annotations[pageNumber]?.map((annotation, index) => (
                  ...
                  >
                    <div className='group relative h-full w-full'>
                      {!isViewing && (
                        <div className='absolute left-1 top-1 cursor-move text-gray-400 transition-colors duration-200 hover:text-gray-600'>
                      ...
                      <div className='absolute right-1 top-1 flex gap-1'>
                        {annotation.type === "text" && handleEditAnnotation && (
                          <Button
                            ...
                            className='h-6 w-6 p-0 text-gray-600 hover:bg-gray-100 hover:text-gray-900'
                          >
                      ...
                      {annotation.type === "signature" ? (
                        ...
                        <img
                          ...
                          className='h-full w-full object-contain'
                        />
                      ) : annotation.type === "clientInput" ? (
                        <div
                          className='flex h-full w-full cursor-pointer items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-2 transition-colors duration-200 hover:border-primary/50'
                          onClick={() => {
                            if (setShowSignaturePad) {
                              setShowSignaturePad(annotation);
                            }
                          }}
                        >
                          {annotation.isPlaceholder ? (
                            <div className='text-center'>
                              {annotation.inputType === "signature" ? (
                                <>
                                  <PenLine className='mx-auto h-6 w-6 text-gray-400' />
                            ...
                            <div className='relative h-full w-full'>
                              ...
                              <div className='absolute inset-0 flex items-center justify-center bg-black/10 opacity-0 transition-opacity duration-200 hover:opacity-100'>
      ...
      <Dialog open={showNameInput} onOpenChange={setShowNameInput}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Add Client Input Placeholder</DialogTitle>
          </DialogHeader>
          <div className='py-4'>
            <div className='space-y-4'>
              <div className='space-y-2'>
                ...
                <input
                  ...
                  className='w-full rounded-lg border p-2 transition-colors duration-200 focus:border-transparent focus:ring-2 focus:ring-primary'
                />
              </div>
              <div className='space-y-2'>
                <label className='block text-sm font-medium text-gray-700'>
                ...
                <div className='flex gap-4'>
                  <button
                    type='button'
                    onClick={() => setSelectedInputType("signature")}
                    className={`flex-1 rounded-lg border p-3 transition-colors duration-200 ${
                      selectedInputType === "signature"
