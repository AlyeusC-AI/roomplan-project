...
export function EventDetailsSheet({
  ...
  const [showStartWorkNotification, setShowStartWorkNotification] =
    useState(false);
  const [showCompleteWorkNotification, setShowCompleteWorkNotification] =
    useState(false);
  ...
  const projectDetails = event.project as any;
  return (
    <>
                  ...
                  <div className='grid grid-cols-2 gap-4'>
                    <div>
                      ...
                      <Badge
                        className={cn(
                          "ml-2",
                          getStatusColor(projectDetails.status)
                        )}
                      >
                    ...
                    {projectDetails.actualValue && (
                      <div>
                        ...
                        <p className='mt-1'>
                          ${projectDetails.actualValue.toLocaleString()}
                        </p>
                      </div>
                    )}
