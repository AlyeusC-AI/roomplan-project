  ...
  const setMarkers = () => {
    ...
    loader.load().then(() => {
      ...
      const markers = hail.map((item, i) => {
        // set custom marker
        const iconBase =
          'http://maps.google.com/mapfiles/kml/shapes/thunderstorm.png'
  ...
  return (
    <>
      <div className="px-4 sm:px-6 lg:px-8">
        ...
        <Transition.Root show={isCreating} // @ts-ignore
 as={Fragment}>
        ...
        <div className="sm:flex sm:items-center">
          <div className="sm:flex-auto">
            ...
            <p className="mt-2 text-sm text-gray-700">
              A list of tornado reports for the last 7 days. The data is
              provided by the NOAA national weather service.
            </p>
            <p className="mt-2 text-sm text-gray-700">
