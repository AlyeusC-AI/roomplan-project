const SkeletonLoader = () => (
  <>
    <div
      role="status"
      className="animate-pulse flex-col space-y-8 md:space-y-0"
    >
      ...
      <div className=" w-full">
        <div className="ounded-full mt-8 mb-2.5 h-2 max-w-[540px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
        ...
        <div className="mb-8 h-2 max-w-[360px] rounded-full bg-gray-200 dark:bg-gray-700"></div>
      </div>
