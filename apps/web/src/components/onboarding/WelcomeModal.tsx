      ...
      <Dialog as='div' className='relative z-10' onClose={() => null}>
        ...
        <div className='fixed inset-0 z-10 overflow-y-auto'>
          <div className='flex min-h-full items-center justify-center p-4 text-center sm:p-0'>
            ...
            >
              <Dialog.Panel className='relative overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-3xl sm:p-6'>
                ...
                <div className='mb-2 mt-4 flex items-center justify-center space-x-2'>
                ...
                <div className='mt-5 flex items-center justify-center space-x-4 sm:mt-6'>
                  {index === 0 && (
                    ...
                    >
                      Next Steps <ArrowRight className='ml-2 size-5' />
                    </PrimaryButton>
                  )}
                  {index > 0 && index < 3 && (
                    <>
