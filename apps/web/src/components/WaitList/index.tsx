...
export default function WaitList() {
  ...
  const onSubmit = async (e: FormEvent) => {
    e.preventDefault()
    // If we have a toast ID then we've already submitted the form.
    // This prevents spamming submit
    if (toastId) {
      return
    }
    ...
    const id = toast.success(`${email} has been added to the wait list.`, {
      duration: Infinity,
    })
    setToastId(id)
  }
            ...
            <div className="relative">
              <div className="sm:text-center">
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg text-blue-200">
                  After a few months of beta testing, we are getting close to a
                  public release. Sign up to get notified as soon as we are
                  ready.
                </p>
              </div>
              <form
