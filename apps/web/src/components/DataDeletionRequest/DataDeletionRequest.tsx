      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div className="bg-gray-50 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="mx-auto max-w-lg">
            ...
            <p className="mt-3 text-lg leading-6 text-gray-500">
              ...
              permantely deleted, you may submit a request to us directly. Once
              deleted the data will be permanently gone forever.
            </p>
            <p className="mt-3 text-lg leading-6 text-gray-500">
              Please note that only <strong>Account Admins</strong> may request
              deletion of an entire organizations data. If you are not an
              account admin, only personally identifiable information will be
              ...
              <div className="mt-3">
                ...
                <dd className="flex">
                  <EnvelopeIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">support@restorationx.app</span>
                </dd>
              </div>
            </dl>
          </div>
        ...
        <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-3 lg:py-24 lg:px-8 xl:pl-12">
          <div className="mx-auto max-w-lg lg:max-w-none">
            {success && (
              <Success title="Data Deletion Request Submitted">
                <div>
                  <p>
                    Your request has been submitted. It may take up to 30 days
                    to fully remove all data from our servers. Once we&apos;ve
                    begun processing your request, you will receive an email.
                  </p>
                  <p className="mt-4">
