...
import AssignStakeholders from '@components/Project/EstimateDetails/DetailsInput/AssignStakeholders'
  ...
  return (
    <>
      ...
      >
        <div className="h-0 flex-1 overflow-y-auto">
          ...
          <div className="flex flex-1 flex-col justify-between">
            {canSetReminder && !projectInfo.clientPhoneNumber && (
              <div className="p- flex flex-1 items-center rounded-md bg-gray-300 p-2">
                      ...
                      <div className="flex-auto">
                        <dl className="flex flex-row text-gray-500">
                          <div className="flex w-full items-start space-x-3">
                            <ul className="flex-grow space-y-4 bg-white px-4 ">
        ...
        {inputError && (
          <Error title="There was a problem, please try again later">
            {inputError}
          </Error>
        )}
