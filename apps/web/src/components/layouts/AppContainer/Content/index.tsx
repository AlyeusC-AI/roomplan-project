...
import NotificationPanel from "unused/NotificationPanel";
  ...
  return (
    <>
      ...
      getNotificationCount.data > 0 ? (
        <span className='absolute -top-2 right-0 flex size-6 items-center justify-center rounded-full bg-red-500 text-xs font-bold text-white shadow-lg'>
  ...
  return (
    <div className='flex h-screen flex-1 overflow-hidden'>
      ...
      {!hideParentNav && (
        <nav
          aria-label='Sidebar'
          className='hidden h-screen md:block md:shrink-0 md:bg-gray-800'
        >
              ...
              <div className='mb-4'>
                <div className='flex items-center justify-between'>
                  ...
                  <TertiaryButton
                    ...
                    noPadding
                  >
                    <BellDotIcon className='size-6 text-gray-400' />
      ...
      <main className='min-w-0 flex-1 flex-row md:flex md:flex-col lg:flex-row'>
        ...
        {renderSecondaryNavigation && (
          <aside className='hidden md:order-first md:block md:shrink-0'>
            <div className='relative flex size-full flex-row overflow-y-auto border-r border-gray-200 bg-gray-100 lg:w-44 lg:flex-col'>
              {renderSecondaryNavigation()}
            </div>
          </aside>
        )}
