import { Speaker, XCircleIcon } from "lucide-react";
      ...
      >
        <div className='flex flex-wrap items-center justify-between'>
          <div className='flex flex-1 items-center'>
            ...
            >
              <Speaker className='size-6 text-white' aria-hidden='true' />
            </span>
          ...
          {isDismissable && (
            <div className='order-2 shrink-0 sm:order-3 sm:ml-2'>
              ...
              >
                ...
                <XCircleIcon className='size-6 text-white' aria-hidden='true' />
              </button>
            </div>
          )}
        </div>
