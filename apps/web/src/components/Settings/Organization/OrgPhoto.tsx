...
//         orgStore.getState().updateLogoId(json.id);
//         setDidErr(true);
//       }
//     } catch (error) {
//       console.error(error);
...
//       </label>
//       {didErr ? (
//         <div className='mt-1 flex size-52 justify-center rounded-md border-2 border-gray-300 px-6 pb-6 pt-5'>
...
//       ) : (
//         <div>
//           <div className='relative mt-1 flex size-52 justify-center rounded-md border-2 border-gray-300 px-6 pb-6 pt-5'>
//             <div>
//               <Image
