      ...
      <Dialog as="div" className="relative z-10" onClose={() => null}>
        <div className="fixed bottom-0 right-0 z-10 overflow-y-auto p-4">
          <div className="flex items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:w-full sm:max-w-3xl sm:p-6">
                <CheckList />
