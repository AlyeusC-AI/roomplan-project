        ...
        {teirs.map((tier) => (
          ...
          >
            <div className='flex-1'>
              ...
              {tier.mostPopular ? (
                <p className='bg-primary-action absolute top-0 -translate-y-1/2 transform rounded-full px-4 py-1.5 text-sm font-semibold text-white'>
                  Most popular
                </p>
              ) : null}
            ...
            {tier.isTrial ? (
              <>
                {user ? (
                  <div
                    className={clsx(
                      "text-primary-action-hover bg-blue-50 hover:bg-blue-50",
                  ...
                  <Link
                    ...
                    className={clsx(
                      tier.mostPopular
                        ? "bg-primary-action hover:bg-primary-action-hover text-white"
                        : "text-primary-action-hover bg-blue-50 hover:bg-blue-100",
                      "mt-8 block w-full rounded-md border border-transparent px-6 py-3 text-center font-medium"
                    )}
                  >
                    {tier.cta}
