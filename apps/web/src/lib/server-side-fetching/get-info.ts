...
export const convertToOrgInfo = (user: Awaited<ReturnType<typeof getUser>>): OrgInfo => ({
...
export const convertToUserInfo = (user: Awaited<ReturnType<typeof getUser>>): UserInfo => ({
  email: user!.email,
